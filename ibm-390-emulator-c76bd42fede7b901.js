...
export class WasmCpu {
    ...
    check_challenge(challenge_id) {
        const ret = wasm.wasmcpu_check_challenge(this.__wbg_ptr, challenge_id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_cc() {
        const ret = wasm.wasmcpu_get_cc(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    get_cc_name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmcpu_get_cc_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get_challenges() {
        const ret = wasm.wasmcpu_get_challenges(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_gpr(reg) {
        const ret = wasm.wasmcpu_get_gpr(this.__wbg_ptr, reg);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     * @returns {any}
     */
    get_memory(start, length) {
        const ret = wasm.wasmcpu_get_memory(this.__wbg_ptr, start, length);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_program_size() {
        const ret = wasm.wasmcpu_get_program_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {number}
     */
    get_program_start_address() {
        const ret = wasm.wasmcpu_get_program_start_address(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get_state() {
        const ret = wasm.wasmcpu_get_state(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    run(max_cycles) {
        const ret = wasm.wasmcpu_run(this.__wbg_ptr, max_cycles);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    set_gpr(reg, value) {
        const ret = wasm.wasmcpu_set_gpr(this.__wbg_ptr, reg, value);
        if (ret[1]) {
     ...
     */
    set_pc(addr) {
        wasm.wasmcpu_set_pc(this.__wbg_ptr, addr);
    }
    /**
    ...
    write_memory(addr, value) {
        const ret = wasm.wasmcpu_write_memory(this.__wbg_ptr, addr, value);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_bubbles_f49ceb31ef86f42b: function(arg0) {
        ...
        __wbg_lastChild_0b22ed4916ab8cfb: function(arg0) {
        ...
        __wbg_parentElement_45ca02e0f5967c4c: function(arg0) {
        ...
        __wbg_set_capture_a853bd3db5681e0b: function(arg0, arg1) {
            arg0.capture = arg1 !== 0;
        },
        ...
        __wbg_set_nodeValue_c50dc3b50c2a8dab: function(arg0, arg1, arg2) {
            arg0.nodeValue = arg1 === 0 ? undefined : getStringFromWasm0(arg1, arg2);
        },
        __wbg_set_passive_5008572704d635e3: function(arg0, arg1) {
            arg0.passive = arg1 !== 0;
        },
        ...
        __wbg_set_value_286417191c84044a: function(arg0, arg1, arg2) {
            arg0.value = getStringFromWasm0(arg1, arg2);
        },
        __wbg_slice_34907933584427ec: function(arg0, arg1) {
        ...
        __wbg_value_c00e81c270632bd1: function(arg0, arg1) {
            const ret = arg1.value;
            const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 414, function: Function { arguments: [Ref(NamedExternref("Event"))], shim_idx: 393, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
            const ret = makeClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__h1628d5e0d00ab385, wasm_bindgen__convert__closures________invoke__h7089958cb4d4b638);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 486, function: Function { arguments: [Externref], shim_idx: 508, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
    ...
    return {
        __proto__: null,
        "./ibm-390-emulator_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures________invoke__h7089958cb4d4b638(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures________invoke__h7089958cb4d4b638(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h0bcb239972d1a1d5(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h0bcb239972d1a1d5(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ibm-390-emulator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
